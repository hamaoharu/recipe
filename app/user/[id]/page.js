...
export default function UserPage({ params }) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10">
      ...
      <Link
        href="/"
        className="mb-8 block font-mono text-[12px] text-zinc-600 transition-colors hover:text-zinc-300"
      >
        ← 一覧に戻る
      </Link>

      {/* Profile */}
      <div className="mb-10 flex items-center gap-5 border-b border-zinc-800 pb-8">
        ...
        <div>
          ...
          <div className="mt-2 flex gap-4 text-[12px] text-zinc-600">
            <span>
              <span className="font-semibold text-zinc-400">{userRoadmaps.length}</span>
              {" "}投稿
            </span>
            <span>
      ...
      <section>
        ...
        {userRoadmaps.length === 0 ? (
          <p className="py-12 text-center text-[14px] text-zinc-600">
            まだ投稿がありません。
          </p>
        ) : (
